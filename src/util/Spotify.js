import ACCES_TOKEN from '../../.env';
const clientId = ACCES_TOKEN;
const redirectUri = 'http://super-jammming.surge.sh';
let accessToken;
...
const Spotify = {
  getAccessToken() {
    ...
    if (accessTokenMatch && expiresInMatch) {
      ...
      // Clear Parameter, allow grabbing a new access token when it epires
